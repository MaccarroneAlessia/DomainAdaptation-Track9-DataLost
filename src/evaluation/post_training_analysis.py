#!/usr/bin/env python3
"""
post_training_analysis.py - Versione Statistica Unificata e Flessibile per Persona 3
...
def main():
    ...
    report_content = f"""# Relazione Finale di Valutazione — Persona 3 Weighting & Evaluation
